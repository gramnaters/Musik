...
export const browseCategories = [
  {
    ...
    name: 'Pop',
    color: '#8c67ab',
    hubQuery: 'pop hits chart',
    hubSubtitle: 'Trending pop picks',
    coverImage: 'https://picsum.photos/seed/musik-browse-pop/960/720',
  },
  {
    id: 'c2',
    name: 'Rock',
    color: '#e61e32',
    hubQuery: 'rock classics anthems',
    hubSubtitle: 'Guitar-forward energy',
    coverImage: 'https://picsum.photos/seed/musik-browse-rock/960/720',
  },
  {
    id: 'c3',
    name: 'Hip-Hop',
    color: '#ba5d07',
    hubQuery: 'hip hop hits 2024',
    hubSubtitle: 'Beats & bars',
    coverImage: 'https://picsum.photos/seed/musik-browse-hiphop/960/720',
  },
  {
    id: 'c4',
    name: 'Indie',
    color: '#1e3264',
    hubQuery: 'indie alternative hits',
    hubSubtitle: 'Left-of-center favorites',
    coverImage: 'https://picsum.photos/seed/musik-browse-indie/960/720',
  },
  {
    id: 'c5',
    name: 'Dance/Electronic',
    color: '#e8115b',
    hubQuery: 'electronic dance edm',
    hubSubtitle: 'Club & festival cuts',
    coverImage: 'https://picsum.photos/seed/musik-browse-edm/960/720',
  },
  {
    id: 'c6',
    name: 'R&B',
    color: '#dc148c',
    hubQuery: 'rnb soul hits',
    hubSubtitle: 'Smooth & modern R&B',
    coverImage: 'https://picsum.photos/seed/musik-browse-rnb/960/720',
  },
  {
    id: 'c7',
    name: 'Jazz',
    color: '#477d95',
    hubQuery: 'jazz standards modern',
    hubSubtitle: 'Swing to contemporary',
    coverImage: 'https://picsum.photos/seed/musik-browse-jazz/960/720',
  },
  {
    id: 'c8',
    name: 'Classical',
    color: '#7d4b32',
    hubQuery: 'classical orchestral',
    hubSubtitle: 'Timeless compositions',
    coverImage: 'https://picsum.photos/seed/musik-browse-classical/960/720',
  },
  {
    id: 'c9',
    name: 'Country',
    color: '#a56752',
    hubQuery: 'country hits nashville',
    hubSubtitle: 'Story songs & twang',
    coverImage: 'https://picsum.photos/seed/musik-browse-country/960/720',
  },
  {
    id: 'c10',
    name: 'Metal',
    color: '#1db954',
    hubQuery: 'metal heavy riffs',
    hubSubtitle: 'High-gain essentials',
    coverImage: 'https://picsum.photos/seed/musik-browse-metal/960/720',
  },
  {
    id: 'c11',
    name: 'Blues',
    color: '#503750',
    hubQuery: 'blues guitar legends',
    hubSubtitle: 'Roots & electric blues',
    coverImage: 'https://picsum.photos/seed/musik-browse-blues/960/720',
  },
  {
    id: 'c12',
    name: 'Folk & Acoustic',
    color: '#148a08',
    hubQuery: 'folk acoustic singer songwriter',
    hubSubtitle: 'Intimate recordings',
    coverImage: 'https://picsum.photos/seed/musik-browse-folk/960/720',
  },
  {
    id: 'c13',
    name: 'Latin',
    color: '#e1118b',
    hubQuery: 'latin pop reggaeton hits',
    hubSubtitle: 'Global Latin charts',
    coverImage: 'https://picsum.photos/seed/musik-browse-latin/960/720',
  },
  {
    id: 'c14',
    name: 'Podcasts',
    color: '#537aa7',
    hubQuery: 'podcast storytelling',
    hubSubtitle: 'Spoken-word discovery',
    coverImage: 'https://picsum.photos/seed/musik-browse-podcast/960/720',
  },
  {
    id: 'c15',
    name: 'Audiobooks',
    color: '#8d67ab',
    hubQuery: 'audiobook fiction bestseller',
    hubSubtitle: 'Narrated listens',
    coverImage: 'https://picsum.photos/seed/musik-browse-audio/960/720',
  },
  {
    id: 'c16',
    name: 'Ambient',
    color: '#b49bc8',
    hubQuery: 'ambient chill soundscapes',
    hubSubtitle: 'Low-tempo focus',
    coverImage: 'https://picsum.photos/seed/musik-browse-ambient/960/720',
  },
] as const;
